...
const outlineButtonClass = "rounded-none cursor-pointer";

const primaryButtonClass = "rounded-none cursor-pointer";
...
const PromoDialog = ({
  ...
  const updateField = <K extends keyof PromoFormValues>(
    key: K,

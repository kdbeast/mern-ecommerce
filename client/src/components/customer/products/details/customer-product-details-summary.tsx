...
import CustomerProductOptionsGroup from "./customer-product-option-group";
...
const primaryButtonClass = "rounded-none sm:flex-1 cursor-pointer";

const secondaryButtonClass = "rounded-none sm:flex-1 cursor-pointer";
...
const CustomerProductDetailsSummary = ({
  product,
  selectedColor,
  selectedSize,
  setSelectedColor,

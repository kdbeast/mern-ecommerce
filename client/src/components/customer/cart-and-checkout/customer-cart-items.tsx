...
const headClass = "border-b border-border bg-secondary px-5 py-4";
...
const qtyButtonClass = "h-9 w-9 rounded-none px-0 cursor-pointer";
const qtyValueClass =
  "flex h-9 min-w-10 items-center justify-center border-x border-border px-2 text-sm font-medium";

const removeButtonClass = "h-9 border-border px-3 text-xs text-white cursor-pointer";

const emptyWrapClass =
  "flex min-h-[320px] flex-col items-center justify-center rounded-2xl border border-dashed border-border bg-muted/50 px-6 text-center";

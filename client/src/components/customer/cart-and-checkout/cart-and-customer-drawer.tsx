...
const rightPaneClass =
  "min-h-0 bg-gradient-to-b from-secondary via-background to-background";
...
const primaryButtonClass = "h-11 w-full cursor-pointer";

const promoTitle =
  "flex items-center gap-2 text-sm font-medium text-foreground";

const infoBoxClass =
  "rounded-2xl border border-dashed border-border bg-background p-4 text-sm text-muted-foreground";

const SummaryRow = (props: { label: string; value: string | number }) => (
...
const CustomerCartAndCheckoutDrawer = () => {
